...
lang = Language(atomics=['F1', 'F2', 'F3', 'F4', 'F5', 'F6', 'F7', 'F8', 'F9', 'F10', 'F11', 'F12', 'F13', 'F14', 'F15', 'F16', 'F17', 'F18', 'F19', 'F20', 'F21', 'F22', 'F23', 'F24', 'F25'],
                constant_arity_dict={'!': 1, '&&': 2, '||' : 2},
                sentential_constants=['false', 'true'],
                metavariables=[],
                context_variables=[])

inf = random_formula_generator.random_formula(depth=2, atomics=['F1', 'F2', 'F3', 'F4', 'F5', 'F6', 'F7', 'F8', 'F9', 'F10', 'F11', 'F12', 'F13', 'F14', 'F15', 'F16', 'F17', 'F18', 'F19', 'F20', 'F21', 'F22', 'F23', 'F24', 'F25'],
                                              language=lang,
