...
public class Constants {
	...
	//-------------------- IDENTIFIER -------------------------------------------------------------------------
	public static final String PLUGIN_PACKAGE               = "eu.hatsproject.absplugin";
	public static final String ABSFRONTEND_PLUGIN_ID        = "eu.hatsproject.abs.compiler"; //Plugin within absfrontend.jar
...
//	public static final String MAUDE_COMMAND = "rew start . \n quit ";
	...
	public static final String CURRENT_INSTRUCTION_POINTER_ID = "eu.hatsproject.absplugin.currentIP";
