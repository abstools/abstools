...
import static eu.hatsproject.absplugin.util.Constants.NAVIGATOR_ID;
...
public class ABSPerspectiveFactory implements IPerspectiveFactory {
	...
	public void createInitialLayout(IPageLayout layout) {
        ...
        layout.addNewWizardShortcut("eu.hatsproject.absplugin.abswizard");
        layout.addNewWizardShortcut("eu.hatsproject.absplugin.absfilewizard");
