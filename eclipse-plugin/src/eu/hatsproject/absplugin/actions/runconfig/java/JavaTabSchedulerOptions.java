...
import static eu.hatsproject.absplugin.actions.runconfig.java.EclipseScheduler.HISTORY;
import static eu.hatsproject.absplugin.actions.runconfig.java.EclipseScheduler.MANUAL;
import static eu.hatsproject.absplugin.actions.runconfig.java.EclipseScheduler.RANDOM;
...
import eu.hatsproject.absplugin.actions.runconfig.AbstractTab;
...
//        gridData.verticalAlignment = SWT.TOP;
    ...
    @Override
    public String getId() {
        return "eu.hatsproject.absplugin.javaTab2";
    }
