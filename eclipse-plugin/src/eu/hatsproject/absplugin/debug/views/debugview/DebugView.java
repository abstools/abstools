package eu.hatsproject.absplugin.debug.views.debugview;
...
import static eu.hatsproject.absplugin.debug.DebugUtils.openVariableView;
import static eu.hatsproject.absplugin.debug.DebugUtils.refreshButtonEnablement;
import static eu.hatsproject.absplugin.debug.DebugUtils.refreshVariableView;
...
public class DebugView extends AbstractDebugView {
	...
	/**
	 * Returns the eu.hatsproject.absplugin.debug.model.Debugger of this view. Whenever a DebugView is created,
