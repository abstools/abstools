...
.Syntax
====
_SimpleIdentifier_ ::= [: lower :] { [: alpha :] | [: digit :] | `_` } +

_SimpleTypeIdentifier_ ::= [: upper :] { [: alpha :] | [: digit :] | `_` } +
...
_Identifier_ ::= _SimpleIdentifier_ | _QualifiedIdentifier_ +
_TypeIdentifier_ ::= _SimpleTypeIdentifier_ | _QualifiedTypeIdentifier_ +
