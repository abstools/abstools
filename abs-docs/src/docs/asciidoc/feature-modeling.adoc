...
as if they occurred in the module named in the `ModuleAccess` clause.  A delta
can always make modifications to classes and interfaces in any module by fully
qualifying the `TypeName` within module modifiers.
