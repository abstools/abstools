...
Building each variant in order to check it is usually not feasible from a 
...
These checks help ensure that all products defined by an SPL specified in ABS can 
be built and are well-typed ABS programs.
