...
public class SequenceDiagramVisualization2 implements SystemObserver, TaskObserver, ObjectCreationObserver, TaskSchedulerObserver {
...
*/        
    ...
    class TaskBlockingObserver extends EmptyTaskObserver {
        ...
        public void taskBlockedOnFuture(TaskView task, FutView fut) {
            synchronized (SequenceDiagramVisualization2.this) {
                if (!isObserved(task))
                    return;
