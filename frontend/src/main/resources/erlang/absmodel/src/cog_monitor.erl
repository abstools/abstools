...
handle_call({keep_alive, Class}, _From, Data=#data{keepalive_after_clock_limit=KeepAlive}) ->
    ...
    {reply, Result, Data};
handle_call({cog,Cog,new}, _From, Data=#data{idle=I})->
    I1=gb_sets:add_element(Cog,I),
    {reply, ok, Data#data{idle=I1}};
...
handle_call({cog,Cog,die}, From,Data=#data{active=A,idle=I,blocked=B,clock_waiting=W, active_before_next_clock=ABNC})->
