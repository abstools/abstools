...
public class LocationTypeVariable {
    ...
    private List<LocationType> parametricFarTypes = new ArrayList<>();

    List<LocationType> farTypes = new ArrayList<>();
    List<LocationType> allCTypes = new ArrayList<>(Arrays.asList(LocationType.ALLCONCRETEUSERTYPES)); // all but bottom
    ...
    public static LocationTypeVariable newVar(Set<Constraint> constraints, ASTNode<?> n, boolean declared, List<LocationType> farTypes, LocationType annotatedType) {
        ...
        if (declared) {
            ...
            MultiListIterable<LocationType> tt = new MultiListIterable<>(farTypes,
                Arrays.asList(LocationType.ALLCONCRETEUSERTYPES));
