...
public class UnifEdge implements Edge {

  private Term t1, t2;
  private History history;

  public UnifEdge(History h, Term t1, Term t2) {
    this.history = h; this.t1 = t1; this.t2 = t2; history.setEdge(this);
  }
  
  public Term getLeft() { return t1; }
  public Term getRight() { return t2; }

  public boolean equals(UnifEdge e) { return ((t1.equals(e.t1)) && (t2.equals(e.t2))); }
