...
public class ABSObject {
	...
	class Field{
		...
		public Field(Element elem) throws Exception{
			/**/if (XMLParser.debug) System.out.println(elem.getNodeName());
	...
	public ABSObject(Element elem) throws Exception{
		...
		/**/if (XMLParser.debug) System.out.println("ObjectType: " + type );
		...
		/**/if (XMLParser.debug) System.out.println(fieldsElem.getNodeName());
