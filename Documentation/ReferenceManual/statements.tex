...
followed by the statement in the \texttt{finally} branch.  If none of the catch branches match, the statements in the \texttt{finally} branch are executed and the error is re-thrown.
