...
The \texttt{abort} statement aborts normal execution of the process, raising
the exception specified via its argument.  When the abort occurs inside one or
...

{
    ...
    try {
        ...
        AnotherAbort => step2 = "caught the wrong thing";
        MyAbort => step2 = "caught";
